...
type Content = TextContent | ImageContent | MediaContent | MediaVariable;
type Function_ = {
    name: string;
    description: string;
...
declare class PromptLayer {
    ...
    get Anthropic(): any;
    get OpenAI(): any;
    run({ promptName, promptVersion, promptReleaseLabel, inputVariables, tags, metadata, groupId, modelParameterOverrides, stream, }: RunRequest): Promise<AsyncGenerator<{
